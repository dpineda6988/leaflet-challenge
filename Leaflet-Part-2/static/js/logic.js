...
function createTectonicPlates(data) {
    let tectonicPlates = L.geoJSON(data).addTo(Map);
    console.log(data.features.coordinates[0]);
}


d3.json("https://fraxen.github.io/tectonicplates/GeoJSON/PB2002_boundaries.json").then(createTectonicPlates);